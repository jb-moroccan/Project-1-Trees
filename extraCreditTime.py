...
startTimeAVLInsert = time.time()

for num in nums: 
  root = myTree.insertIter(root, num) 

endTimeAVLInsert = time.time()

print()
print("Iterative AVL Tree")
print()
print("Total time for 10000 inserts: {} milliseconds".format((endTimeAVLInsert-startTimeAVLInsert) * 1000))

startTimeAVLDelete = time.time()
for num in nums:
  root = myTree.deleteIter(root, num)
endTimeAVLDelete = time.time()
print("Total time for 10000 deletes: {} milliseconds".format((endTimeAVLDelete-startTimeAVLDelete) * 1000))
...
first = True
startTimeBSTInsert = time.time()
for num in nums:
  if first:
    bstIterRoot = insertIter(bstIterRoot, num)
  else:
    insertIter(bstIterRoot, num)
endTimeBSTInsert = time.time()

print()
print("Iterative BST")
print()
print("Total time for 10000 inserts: {} milliseconds".format((endTimeBSTInsert-startTimeBSTInsert) * 1000))

startTimeBSTDelete = time.time()
for num in nums:
  if first:
    bstIterRoot = deleteIter(bstIterRoot, num)
  else:
    deleteIter(bstIterRoot, num)
endTimeBSTDelete = time.time()
print("Total time for 10000 deletes: {} milliseconds".format((endTimeBSTDelete-startTimeBSTDelete) * 1000))
